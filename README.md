...
For plain HTML with no build step, load published files from a CDN. **Pin the version** in production (replace `0.1.2` with the version you want):

```html
<link
  rel="stylesheet"
  href="https://cdn.jsdelivr.net/npm/dark-reader-aware-theme-toggle-button@0.1.2/styles/toggle-button.css"
>
...
<script src="https://cdn.jsdelivr.net/npm/dark-reader-aware-theme-toggle-button@0.1.2/dist/global.js"></script>
<script>
...
```html
<link rel="stylesheet" href="https://unpkg.com/dark-reader-aware-theme-toggle-button@0.1.2/styles/toggle-button.css">
<script src="https://unpkg.com/dark-reader-aware-theme-toggle-button@0.1.2/dist/global.js"></script>
```
